...
/**
 * POST /api/compras-internacionales/reyma/factura/extraer — paso 1 de la carga (A12).
 *
 ...
 * volvieran, cualquiera con una sesión de `compras_internacionales` podría postear
