...
import { conciliar, type DecisionPersistida } from '@/app/(authenticated)/compras-internacionales/reyma-vivo/conciliacion';
import type { FacturaLinea, FacturaPdfLinea } from '@/app/(authenticated)/compras-internacionales/reyma-vivo/types';
import { autor, badRequest, insertRow, withWriteAuth } from '../lib';

export const dynamic = 'force-dynamic';

/**
 * POST /api/compras-internacionales/reyma/conciliacion — N14.
 *
