...
import type {
  ...
  TransitoDetalle,
  VivoRow,
} from '@/app/(authenticated)/compras-internacionales/reyma-vivo/types';
import { DIAS_HABILES_DEFAULT, etaCalculada, resolverEta } from '@/app/(authenticated)/compras-internacionales/reyma-vivo/eta';

export const dynamic = 'force-dynamic';

/**
 * GET /api/compras-internacionales/reyma — the LIVE Reyma model (Alexis / Compras Internacionales).
 *
 ...
 * in-handler requireAuth(CAN_VIEW_COMPRAS_INTERNACIONALES).
 */
