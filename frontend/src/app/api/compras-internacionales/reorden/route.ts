...
import type { FilaReorden, ParamsReorden } from '@/lib/compras-internacionales/reorden';

export const dynamic = 'force-dynamic';

/**
 * GET /api/compras-internacionales/reorden?modelo=darnel — A4.27.
 *
 * Sirve los INSUMOS del modelo de punto de reorden. El cálculo NO ocurre acá:
 * corre en el cliente con `lib/compras-internacionales/reorden.ts`, que es el mismo módulo
